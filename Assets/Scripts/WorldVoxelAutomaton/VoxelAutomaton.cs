...
public abstract class VoxelAutomaton<VoxelType> : MonoBehaviour
{
    ...
    public int margolus_frame = 0; // how many steps has the automaton computed
    ...
    {
        return GlobalUtils.IsOutOfBounds(index.x, index.y, index.z, this.automaton_dimensions);
    }
    ...
    {
        return GlobalUtils.IsOutOfBounds(x, y, z, this.automaton_dimensions);
    }
    ...
    {
        int i = GlobalUtils.Index_FlatFromint3(x, y, z, automaton_dimensions);
    ...
    {
        return GetCellInfo(grid_state, GlobalUtils.Index_FlatFromint3(x, y, z, automaton_dimensions));
    }
    ...
    public virtual VoxelType GetCellCurrentState(Vector3Int position)
    {
        int i = GlobalUtils.Index_FlatFromint3(position.x, position.y, position.z, automaton_dimensions);
        return GetCellCurrentState(this.cell_grid, i);
    }

    public virtual VoxelType GetCellNextState(Vector3Int position)
    {
        int i = GlobalUtils.Index_FlatFromint3(position.x, position.y, position.z, automaton_dimensions);
        return GetCellNextState(this.cell_grid, i);
    }
    ...
    {
        SetCellNextState(this.cell_grid, this.margolus_frame, i, state);
    }
    /// <summary>
    ///     Set the current state of a cell. Also flags the cell as modified during this frame.
    /// </summary>
    ...
    {
        SetCellNextState(this.cell_grid, this.automaton_dimensions, this.margolus_frame, x, y, z, state);
    }

    public virtual void SetCellNextState(Vector3Int position, VoxelType state)
    {
        SetCellNextState(this.cell_grid, this.automaton_dimensions, this.margolus_frame, position.x, position.y, position.z, state);
    }
