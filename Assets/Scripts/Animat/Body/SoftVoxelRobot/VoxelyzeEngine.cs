...
public class VoxelyzeEngine : MonoBehaviour
{
    ...
    [DllImport(DLL_path)]
    public static extern CVoxelyze CreateCVoxelyze(float voxel_size, int[] worldDims);
    ...
    [DllImport(DLL_path)]
    public static extern CVX_Material GetVoxelMaterial(CVX_Voxel voxel);

    [DllImport(DLL_path)]
    public static extern CVX_Material GetVoxelMaterialFromCoords(CVoxelyze voxel_object, int x, int y, int z);
    ...
    [DllImport(DLL_path)]
    public static extern float GetNextQuadNormal(CVX_MeshRender mesh, int index);
    ...
    [DllImport(DLL_path)]
    public static extern void AddVoxelToWorld(CVoxelyze voxelyze_obj, int x, int y, int z, int value);
}
